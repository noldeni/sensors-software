...
const char INTL_DISPLAY[] PROGMEM = "Displej";
...
const char INTL_ERSTER_MESSZYKLUS[] = "Zbývá {v} sekund do prvního mìøení.";
const char INTL_ZEIT_SEIT_LETZTER_MESSUNG[] = " sekund od posledního mìøení.";
