...
const char INTL_NETZWERKE_GEFUNDEN[] = "Nätverk hittades: ";
...
const char INTL_ERSTER_MESSZYKLUS[] = "Det är {v} sekunder kvar till första mätningen.";
const char INTL_ZEIT_SEIT_LETZTER_MESSUNG[] = " sekunder sedan den senaste mätningen.";
